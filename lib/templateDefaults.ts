...
export const DEFAULT_TEMPLATE_CONFIG: TemplateConfig = {
  ...
  textZones: [
    { id: "headline", x: 80, y: 720, w: 920, h: 260, fontSize: 68, fontWeight: 600, lineHeight: 1.05, maxLines: 3, align: "center" },
...
export const LAYOUT_PRESETS: Record<TemplateConfig["layout"], TemplateConfig> = {
  ...
  headline_center: {
    ...
    textZones: [
      { id: "headline", x: 80, y: 380, w: 920, h: 320, fontSize: 64, fontWeight: 600, lineHeight: 1.1, maxLines: 5, align: "center" },
  ...
  split_top_bottom: {
    ...
    textZones: [
      { id: "headline", x: 80, y: 80, w: 920, h: 200, fontSize: 56, fontWeight: 600, lineHeight: 1.1, maxLines: 3, align: "left" },
  ...
  headline_only: {
    ...
    textZones: [
      { id: "headline", x: 80, y: 340, w: 920, h: 400, fontSize: 80, fontWeight: 600, lineHeight: 1.05, maxLines: 4, align: "center" },
    ],
  },
};
