...
${ctx.use_ai_backgrounds ? (ctx.use_unsplash_only
  ...
  • COMIC BOOKS, FICTIONAL CHARACTERS, ANIME, SUPERHEROES: Do NOT use "press photo", "official photo", or "press kit" in image queries—there is no such thing for comics/characters. Use "key art", "official artwork", or "concept art" instead (e.g. "Spider-Man key art 3000x2000", "Marvel character official artwork"). Be intelligent about the topic: real people get press/photo style; fictional/comic get art style.
