...
${ctx.use_ai_backgrounds ? (ctx.use_unsplash_only
  ...
  • 1 IMAGE: almost always. One query string, e.g. image_queries: ["nature landscape peaceful"] or ["Lionel Messi 4k"].
  ...
  • SLIDE 1 (hook): Use the MAIN SUBJECT of the carousel—the person, character, or figure that defines the topic. If the carousel is about Jesus, use Jesus; about Moses, use Moses; about a celebrity or athlete, use that person. Do NOT use a generic object (e.g. Bible, book, landscape) when the topic centers on a specific person or character. The first slide image should be the face/subject that will convert for likes and shares—highly recognizable and directly related.
  • LAST SLIDE (final image): Use a highly relatable, iconic image for the topic—e.g. movies: famous actor or character; sports: star athlete; music: artist or band; books: author or cover. Something the audience instantly recognizes and connects to the topic. No generic stock; pick a specific, topic-iconic subject.
