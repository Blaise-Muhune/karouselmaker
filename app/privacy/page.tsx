...
export default function PrivacyPage() {
  return (
    <LegalPageShell title="Privacy Policy" updated="September 20, 2026">
      <Section title="1. What this policy covers"><Copy>This policy explains how Karouselmaker handles information when you use our website and carousel-creation service. It applies to information you provide and information created while providing the Service.</Copy></Section>
      <Section title="2. Information we handle">
        <List>
          ...
          <li><strong className="text-foreground">Connected social accounts:</strong> when you connect TikTok, we store OAuth tokens, your TikTok user id and username, and post settings you choose (visibility, interaction options, commercial disclosure, title, caption, and schedule time) so we can publish on your behalf.</li>
      ...
      <Section title="3. How we use information"><List><li>Authenticate you, save your workspace, and render or export your carousels.</li><li>Generate requested drafts, captions, hashtags, and related carousel content.</li><li>When you connect TikTok and schedule a post, query your current TikTok creator settings, prepare slide images, and send the post through TikTok&apos;s Content Posting API using the visibility and disclosure choices you select.</li><li>Process subscriptions and post-pack purchases, apply plan limits, and prevent fraud or misuse.</li><li>Answer support requests, diagnose errors, protect the Service, and meet legal obligations.</li></List></Section>
      <Section title="4. Service providers and connections">
        ...
        <List>
          ...
          <li><strong className="text-foreground">TikTok:</strong> only when you connect an account and choose to post. We use TikTok Login Kit and the Content Posting API (Direct Post / Photo Mode). TikTok receives the images, title, caption, privacy level, interaction settings, and commercial disclosure you confirm. TikTok&apos;s own terms and privacy policy also apply. You can disconnect TikTok in the Post to TikTok panel; that removes our stored connection tokens so we can no longer post for that account until you reconnect.</li>
      ...
      <Section title="6. Retention and deletion"><Copy>We keep account and workspace data while your account is active and for a reasonable period afterward for backups, security, billing, dispute resolution, and legal compliance. Scheduled TikTok post records and temporary media URLs are kept long enough to complete publishing and short diagnostics, then cleaned up with ordinary retention. You can remove content from the Service where deletion controls are available, and you can disconnect TikTok at any time. To request access, correction, or deletion of personal data, use Contact us. We may need to retain limited information when law or legitimate operational needs require it.</Copy></Section>
      ...
      <Section title="8. Your rights and choices"><Copy>Privacy laws in your location may give you rights to request access, correction, deletion, portability, or to object to certain processing. Use Contact us to make a request. We may need to verify your identity and will respond as required by applicable law. For TikTok specifically, you can disconnect the integration in-product; that stops future posts from Karouselmaker.</Copy></Section>
