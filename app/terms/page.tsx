...
export default function TermsPage() {
  return (
    <LegalPageShell title="Terms of Service" updated="September 20, 2026">
      <Section title="1. Using Karouselmaker">
        <Copy>Karouselmaker helps you turn a project, product context, and topic into an editable social carousel. The Service can draft slide copy, captions, and hashtags; apply templates; use library or selected third-party images; export individual images, ZIP files, or PDF documents where available; and, when you choose, connect TikTok to schedule a Photo Mode Direct Post.</Copy>
      ...
      <Section title="5. TikTok posting">
        <Copy>If you connect TikTok, you authorize Karouselmaker to obtain a token from TikTok, read your current creator posting settings, and submit Photo Mode posts you schedule, using the title, caption, visibility, interaction options, and commercial disclosure you confirm in the Post to TikTok flow.</Copy>
        <Copy>You must comply with TikTok&apos;s Terms of Service, Community Guidelines, Music Usage Confirmation, and Content Sharing Guidelines. You are responsible for whether content is appropriate to post, whether commercial disclosure is accurate, and whether the connected TikTok account may receive Direct Posts (including any private-account or audit restrictions TikTok applies).</Copy>
        <Copy>You can disconnect TikTok at any time in the Post to TikTok panel. Disconnecting removes our stored connection so we cannot post for that account until you reconnect. Scheduled jobs that have not yet published may fail after disconnect.</Copy>
      </Section>
      <Section title="6. Plans, subscriptions, and post packs">
      ...
      <Section title="10. Contact"><Copy>Use the Contact us link in the footer for questions about these terms or the Service.</Copy></Section>
    </LegalPageShell>
  );
}
