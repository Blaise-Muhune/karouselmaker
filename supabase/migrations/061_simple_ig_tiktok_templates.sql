-- Simple Instagram/TikTok-friendly system templates (portrait).
-- Safe additive seed; does not delete existing system templates.
-- Design space 1080×1080 (scaled to 4:5 / 9:16 at export).
